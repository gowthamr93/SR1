...
{
	public class PropertyMappingComparer : IComparer<PropertyMapping>
	{
		/// ------------------------------------------------------------------------------------------------
		...
		/// ------------------------------------------------------------------------------------------------
		/// 
		public int Compare(PropertyMapping x, PropertyMapping y)
		{
			int result;
			SRiProperty propX, propY;
			//
			propX = AppData.PropertyModel.PropertyFromMapping(x);
			propY = AppData.PropertyModel.PropertyFromMapping(y);
