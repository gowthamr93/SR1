...
namespace ServiceRequest.UWP
{
    ...
    sealed partial class App : Application
    {
        ...
        public App()
        {
            ...
            AppData.Version = new OnSiteVersion(string.Format("{0}.{1}.{2}",                Package.Current.Id.Version.Major,                Package.Current.Id.Version.Minor,                Package.Current.Id.Version.Build));
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame == null)
            {
                ...
                Xamarin.FormsMaps.Init("EBluhremUIEFIJHxuhLu~p13Cqk8HmULBachuX56Htw~Aq7mhwQ6IBoBm31rHk7hHALJMJ78AkfDOdFpcNy1VpycneXTMQ8mro4XVC8cy5Fd");
        ...
        public static async Task writingfile(ErrorReport report)
        {
            ...
            var write = await FileSystem.Write(report.Serialised, "error.txt");
